...
$(document).ready(function () {
    var displaylimit = 7;
    var twitterprofile = "lolesports";
	var screenname = "lolesports";
	...
	var headerHTML = '';
	var loadingHTML = '';
	headerHTML += '<a href="https://twitter.com/" target="_blank"><img src="/../img/TwitterLogo.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
    ...
    $.getJSON('http://localhost/website/TwitterFeeds/LeagueTwitter/LeagueTweets1.1.php', //Edit this for specific php file with json
        function(feeds) {   
		   //alert(feeds);
            var feedHTML = '';
